        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
              <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                  <li class="active">
                    <a href="index1.php"><img src="assets/img/icons/dashboard.svg" alt="img"><span>
                        Dashboard</span> </a>
                  </li>
                  <li class="submenu">
    ...
    <script>
        document.querySelectorAll('.sidebar-item').forEach(item => {
            item.addEventListener('click', function() {
                ...
                document.querySelectorAll('.sidebar-subitem').forEach(el => el.classList.remove('active-subitem'));
        ...
        document.querySelectorAll('.sidebar-subitem').forEach(subitem => {
            subitem.addEventListener('click', function(event) {
                ...
                this.closest('.submenu').querySelector('.sidebar-item').classList.add('active-item');
            });
        });
    </script>
</body>
